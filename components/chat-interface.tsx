...
export function ChatInterface() {
  ...
  const [isContextGatheringComplete, setIsContextGatheringComplete] = useState(false)
  const [businessPlanMarkdown, setBusinessPlanMarkdown] = useState<string | null>(null)
  ...
  const handleContextGatheringComplete = (contextData: any) => {
    const initialContext: Partial<ContextSummary> = {
      businessType: contextData.businessType || contextData.productsServices || "Not yet specified",
      painPoints: contextData.cashFlowRisks || contextData.marketingWeaknesses || "Not yet specified",
  ...
  const startConversation = async (initialContext: ContextSummary | null) => {
    ...
    try {
      let initialMessage = "Hello, I'm ready to start the 5-question discovery process for my small business."

      if (initialContext) {
        initialMessage += " Here's some information about my business: "

        if (initialContext.businessType && initialContext.businessType !== "Not yet specified") {
        ...
        if (initialContext.painPoints && initialContext.painPoints !== "Not yet specified") {
      ...
      if (data.message) {
        ...
        if (data.fallback) {
          toast({
            ...
            description: "AI service temporarily unavailable, using backup responses.",
            variant: "default",
          })
        }
      } else {
      ...
      if (data.message) {
        ...
        if (data.businessPlanMarkdown) {
          ...
          toast({
            ...
            description: "Your personalized business plan is ready to view, copy, and download.",
          })
...
**Click "Start Over" below** to generate a fully personalized business plan with more detailed information about your business.`)
        ...
        toast({
          ...
          description: "We've provided a template business plan. Restart for a custom plan.",
          variant: "default",
        })
      }
    } finally {
    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="hidden lg:flex w-64 border-r bg-card p-6 flex-col">
        <div className="mb-8 flex items-center space-x-3">
          <Image src="/logo.png" alt="5Q Logo" width={48} height={48} className="rounded-lg" />
          <div>
            <h1 className="text-xl font-bold text-primary">5Q for SMBs</h1>
            <p className="text-sm text-muted-foreground">AI Strategy in 5 Questions or Less</p>
          </div>
        </div>
        ...
        <div className="mt-auto space-y-2">
          <Button variant="outline" size="sm" onClick={resetChat} className="w-full">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="border-b p-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Image src="/logo.png" alt="5Q Logo" width={32} height={32} className="rounded lg:hidden" />
            <div>
              <h2 className="font-semibold">
                {businessPlanMarkdown ? "Your Business Plan" : "Business Discovery Chat"}
              </h2>
            ...
            <div className="flex flex-col items-center justify-center h-full text-center space-y-6 p-4">
              <div className="max-w-md">
                <div className="flex justify-center mb-6">
                  <Image src="/logo.png" alt="5Q Logo" width={80} height={80} className="rounded-xl" />
                </div>
                <h3 className="text-2xl font-bold mb-3 text-primary">Welcome to 5Q for SMBs</h3>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  ...
                  <br />
                  At the end? You'll get a legit business plan that would've cost you $10K from a consultant.
                  <br />
                  <br />
                  Type it out or talk it out. Either way, you'll walk out smarter.
                </p>
                <Button
              ...
              {isGeneratingPlan && (
                <div className="flex flex-col items-center justify-center py-8 space-y-4">
                  ...
                  <div className="text-center">
                    <p className="text-lg font-medium">Generating your personalized business plan...</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      Analyzing your responses and creating actionable recommendations
                    </p>
                  </div>
                </div>
              )}
